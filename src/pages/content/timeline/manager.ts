...
const HOST_USER_SELECTORS: Record<string, string[]> = {
  'chat.deepseek.com': [
...
export class TimelineManager {
  ...
  private computeConversationId(): string {
    ...
    // Prefix by host to avoid cross-site collisions (e.g., gemini vs chatgpt)
  ...
  private async findCriticalElements(): Promise<boolean> {
    ...
    const hostSpecific = HOST_USER_SELECTORS[host] || [];
